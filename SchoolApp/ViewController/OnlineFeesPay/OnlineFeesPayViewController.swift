//
//  OnlineFeesPayViewController.swift
//  SchoolApp
//
...
class OnlineFeesPayViewController: UIViewController {
    //navigation view
    ...
    func setUpView(){
        ...
        self.lblTitle.text = Vocabulary.getWordFromKey(key:"genral.onlinefeespay")
...
extension OnlineFeesPayViewController:UITableViewDelegate,UITableViewDataSource{
...
extension OnlineFeesPayViewController:UIWebViewDelegate{
